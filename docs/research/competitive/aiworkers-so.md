...
| Prebuilt specialists | **1,902 packs across 53 suites** (lint-audited) | ~50 worker profiles |
...
4. **Breadth on a governed core.** 1,902 specialists vs ~50; 289 tool modules;
...
1. **Ship a "Hire a worker" persona layer over the 1,902 packs.** Their entire
...
**53 suites / 1,902 packs** and a real fleet orchestrator (`fleet.py`,
...
breadth advantage into a single SKU instead of 1,902 line items.
...
- **Pack / suite marketplace** — the 1,902 packs plus partner-built and
