...
| **Safety** | HIPAA mode profile · differential privacy on usage stats · two-person rule for irreversible ops · shield calibration dashboard · adversarial eval harness · coordinated-disclosure log · multi-agent collusion detector · per-agent identity + signing · capability delegation graph · watermark detector · image-content classifier · voice safety pass · geofence config · privacy budget per user · red-team CI |
