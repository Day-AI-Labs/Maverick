...
| **Performance** | JIT consideration (mypyc/cython on hot path) · compaction v5 multi-modal · autoscaling local backends · real-time anomaly detection · tail-latency hunting · KV-cache offload to disk · 2-year retrospective |
