...
| **UX** | Native macOS/Windows/Linux GUI apps · browser extension · replay export to MP4 · VS Code + JetBrains live-run extensions · TUI mouse mode · accessibility audit pass · i18n community portal |
