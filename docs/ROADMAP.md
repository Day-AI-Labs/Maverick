...
| **Ecosystem** | ACD spec v1.0 · Threads + RCS channels · Anki integration · web archive tool · GitHub repo search · Redis world-model · marketplace v2 (federated indexes) · IDE protocol unification (one MCP server, multiple editors) · generic OAuth helper · DuckDB world-model · Cloudflare Workers + Modal sandboxes |
