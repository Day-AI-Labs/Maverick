...
| **Performance** | compaction v8 graph-structured · critical-path-aware parallel scheduling · provider-side caching analytics · 3-year retrospective benchmark · reliability cert · public perf SLA · sunset deprecated paths |
