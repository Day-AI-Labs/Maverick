...
|---|---|
| **Capabilities** | Audio understanding (non-speech CLAP) · plan-execute-reflect loop topology · cross-language LSP bridge · speculative parallel tool calls · speech-to-action live-mic · image gen + edit tools · ASR meeting listener · auto-skill distillation v2 |
| **UX** | Multi-run dashboard · pinned watch list · annotated traces · comparative replay · mobile push v2 · Apple Watch glance · voice in channels v2 (Discord stages) · high-contrast & dyslexic fonts · i18n expansion (fr/de/ja/zh) · visual graph editor · tool-call inspector · latency heatmap · saved dashboard views · channel reply threading · drag-and-drop goal builder · plain-language explanations |
...
| **Safety** | HIPAA mode profile · shield calibration dashboard · image-content classifier · voice safety pass · red-team CI |
