...
| **Safety** | Safety steering group · backport security fixes · external SOC2 Type I · misuse leaderboard removal (verified absent — the repo contains no misuse leaderboard to remove; resolved) |
...
| **Ecosystem** | Plugin API v3 RFC (if warranted) · 3-year retrospective + 2029-2031 plan |
