...
| **UX** | Native macOS/Windows/Linux GUI apps · browser extension · voice persona presets · multi-language voice · wizard branching paths · run gallery · replay export to MP4 · collaborative supervision (multi-user dashboard) · trace pinning to commit · VS Code + JetBrains live-run extensions · TUI mouse mode · run-as-tutorial export · accessibility audit pass · i18n community portal |
