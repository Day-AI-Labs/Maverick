...
| **Safety** | misuse leaderboard removal · safety steering group · formal verification of sandbox interface (TLA+) · multi-tenant isolation tests · long-horizon goal review checkpoint · backport security fixes · external SOC2 Type I |
