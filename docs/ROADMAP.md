...
| **UX** | cross-device handoff · embedded video walkthroughs · granular redaction UI · voice biometric unlock · power-user keymap editor · 3D plan-tree (WebGL/VR) · self-healing UX · onboarding personalization v2 · "achievements" · universal share link |
