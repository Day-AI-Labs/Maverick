...
| **Safety** | HIPAA mode profile · shield calibration dashboard · adversarial eval harness · coordinated-disclosure log · multi-agent collusion detector · per-agent identity + signing · image-content classifier · voice safety pass · red-team CI |
