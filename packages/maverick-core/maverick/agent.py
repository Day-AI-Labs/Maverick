        ...
        for step in range(start_step, self.max_steps):
            ...
            if run_parallel:
                ...
                for tc in resp.tool_calls:
                    ...
                    # tamper-evident link before each CONSEQUENTIAL tool call
                    # so the tool cannot corrupt its own audit entry before the
                    # hook runs. Fail-open: never breaks a run.
                    try:
