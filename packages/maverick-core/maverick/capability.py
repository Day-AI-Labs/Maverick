...
# The coordination control-plane: tools that let a specialist participate in
# the workforce -- discover peers, spawn specialists, fan out a swarm, and
# message/delegate across the agent bus. These names are grouped for shared
# policy/tests only; they are still subject to the normal capability checks
# (deny-list, fail-closed sentinel, allowlist, and risk ceiling).
