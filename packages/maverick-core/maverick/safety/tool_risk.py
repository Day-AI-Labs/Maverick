...
_DEFAULT_RISK: dict[str, str] = {
    ...
    "github_actions": "high",
    "openapi_runner": "high",
    # high: enterprise REST connectors that can read secrets or mutate cloud,
    # IAM, security, analytics, and CI/CD systems. Keep these explicit so a
    # max_risk="medium" ceiling cannot admit sensitive external integrations
    # merely because they were newly registered.
    "fastly": "high",
    "akamai": "high",
    "digitalocean": "high",
    "terraform": "high",
