...
_DEFAULT_RISK: dict[str, str] = {
    ...
    "spawn_subagent": "high",
    "spawn_swarm": "high",
    # high: mutating enterprise REST connectors (cloud/security/comms/DB/BI/ERP).
    # Generic REST write operations only require a model-supplied confirm flag,
    # so these connectors must not be reachable under a medium-risk ceiling.
    "kubernetes": "high",
    "openshift": "high",
    "vsphere": "high",
    "azure": "high",
